...
function guardarCambios(product) {
  ...
  if (updatedProductIndex !== -1) {
    ...
    productosAlmacenados[updatedProductIndex] = {
      ...productosAlmacenados[updatedProductIndex],
      title: document.getElementById("updateProductName").value,
  ...
  if (elementoExistente) {
    ...
    if (titleElement) titleElement.textContent = productosAlmacenados[updatedProductIndex].title;
    if (imageElement) imageElement.src = productosAlmacenados[updatedProductIndex].image;
    if (priceElement) priceElement.textContent = `${productosAlmacenados[updatedProductIndex].price}`;
    if (descriptionElement) descriptionElement.textContent = productosAlmacenados[updatedProductIndex].description;
  }
